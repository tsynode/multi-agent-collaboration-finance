...
from bedrock_helpers import Agent, SupervisorAgent, Task, account_id
...
def main(args):
    ...
    voyage_virtuoso = SupervisorAgent.direct_create("voyage_virtuoso", 
    ...
    if args.recreate_agents == "false":
        ...
        result = voyage_virtuoso.invoke_with_tasks([travel_recommendation_task], 
...
if __name__ == '__main__':
    ...
    parser.add_argument("--region", required=False, default="us-west-2", help="The region to use for cloud resources.")
    parser.add_argument("--trace_level", required=False, default="core", help="The level of trace, 'core', 'outline', 'all'.")
    parser.add_argument("--voyage", required=False, help="Brief description of the amazing voyage you want to take",
