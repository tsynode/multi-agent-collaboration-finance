...
def main(args):
    ...
    stock_data_tool = Tool({
            "code": f"arn:aws:lambda:{inputs['region']}:355151823911:function:stock_data_lookup",
            "definition": { 
...
if __name__ == '__main__':
    ...
    parser.add_argument("--ticker", required=True, help="The stock ticker to analyze")
